...
from model.encoder.lstm import get_lstm_model_raw
from model.encoder.lstm_args_core import dataset_params, model_params, run_params 
...
if __name__ == '__main__':
    ...
    model = get_lstm_model_raw(dataset_params['padding_input_max_length'], 
