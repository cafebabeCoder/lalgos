...
from model.encoder.lstm import get_gru_model_raw
from model.encoder.gru_args_core import dataset_params, model_params, run_params 
...
if __name__ == '__main__':
    ...
    model = get_gru_model_raw(dataset_params['padding_input_max_length'], 
        ...
        rate=0.1)
    # lr
    learning_rate = 0.0005 # CustomSchedule(model_params['d_model'], warmup_steps=500) 
